...
func (h *Handler) GetAgent(w http.ResponseWriter, r *http.Request) {
	...
	// Built-in descriptions are consumed only by the detail-page Skills tab.
	// Keep the inventory off list, mutation, and WebSocket payloads.
	resp.BuiltinSkills = h.builtinSkillSummaries(agent.SystemKey.String, agent.EnabledBuiltinSkillIds)
